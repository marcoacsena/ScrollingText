    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_editar:
                Toast.makeText(this, "O item de menu selecionado foi Editar!", Toast.LENGTH_LONG).show();
                return true;
            case R.id.action_compartilhar:
                Toast.makeText(this, "O item de menu selecionado foi Compartilhar!", Toast.LENGTH_LONG).show();
                return true;
            case R.id.action_excluir:
                Toast.makeText(this, "O item de menu selecionado foi Excluir!", Toast.LENGTH_LONG).show();
                return true;
            default:
